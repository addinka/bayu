...
export class AupagedetailPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.metaService.updateTag({ name: 'twitter:image:src', content: "https://www.wickedcampers.com.au/assets/images/socialmedia/vehicle.jpg"});
    // Facebook
    ...
    this.metaService.updateTag({ property: 'og:image', content: 'https://www.wickedcampers.com.au/assets/images/socialmedia/vehicle.jpg' });
    //app
